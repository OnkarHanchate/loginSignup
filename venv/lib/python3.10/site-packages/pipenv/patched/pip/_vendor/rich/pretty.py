...
JUPYTER_CLASSES_TO_NOT_RENDER = {
    # Matplotlib "Artists" manage their own rendering in a Jupyter noteuser, and we should not try to render them too.
...
def _ipy_display_hook(
    ...
    if console.is_jupyter:
        ...
        # When in a Jupyter noteuser let's avoid the display of some specific classes,
